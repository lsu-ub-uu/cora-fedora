...
public class FedoraConflictExceptionTest {
	@Test
	public void testInit() {
		String message = "message";
		FedoraConflictException exception = FedoraConflictException.withMessage(message);
	...
	public void testMessageAndError() throws Exception {
		...
		FedoraConflictException storageException = FedoraConflictException
